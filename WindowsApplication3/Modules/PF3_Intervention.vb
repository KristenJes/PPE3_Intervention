Public Class PF3_Intervention
    ...
    Private Sub INTERVENTION_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        sdisAdress = "SELECT INTERV_NO || ' ' || INTERV_LIEU, NOM_COMMUNE FROM INTERVENTION a, COMMUNE b WHERE b.CODE_COMMUNE=a.INTERV_COMMUNE AND a.INTERV_ID=" & idIntervention
    ...
    Private Sub btnRenforts_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRenforts.Click
        Dim EnvoiRenfort As New Renfort
        EnvoiRenfort.Show()
    End Sub
